...
export default function DebtCard({
  ...
  return (
    <div className="group rounded-3xl border border-slate-100 bg-white/90 p-6 shadow-sm ring-1 ring-slate-100 transition-all hover:-translate-y-1 hover:shadow-lg">
